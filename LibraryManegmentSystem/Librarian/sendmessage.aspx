<%@ Page Title="" Language="C#" MasterPageFile="~/Librarian/Librarian.Master" AutoEventWireup="true" CodeFile="sendmessage.aspx.cs" Inherits="LibraryManegmentSystem.Librarian.sendmessage" %>
                    ...
                    <asp:Repeater ID="r1" runat="server">
                        ...
                        <itemtemplate>
                            <tr>
                                ...
                                <td><%#Eval("contact") %></td>
                                <td><%#Eval("approved") %></td>
                                <td><a class="btn btn-secondary btn-sm" href="communication.aspx?username=<%#Eval("username") %>"><i class="fa fa-lightbulb-o"></i>&nbsp; Message</a></td>
